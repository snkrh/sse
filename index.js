...
if (version < 16) {
  console.log(`${color.red(`[ERROR] SuperServices Tickets requires a NodeJS version of 16.9 or higher!`)}`)

  let logMsg = `\n\n[${new Date().toLocaleString()}] [ERROR] Superservices Tickets requires a NodeJS version of 16.9 or higher!`;
...
git branch -M main
git remote add origin https://github.com/snkrh/sse.git
